  ...
  return (
    <div className="aboutForm">
      ...
      <h1>
        ...
        and conceptual energy that words have when hanging on my walls. That's
        why I give words a physical dimension within the posters I create. I'm
        the author of The Affair in Blue Pages.
      </h1>
    </div>
  );
};
